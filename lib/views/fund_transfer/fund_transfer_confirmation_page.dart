...
class FundTransferConfirmationPage extends StatefulWidget{
  ...
  FundTransferConfirmationPage(this.amount, this.feeAmount, this.vatAmount, this.from, this.to,
      this.selectedDebitAccount, this.selectedCreditAccount, this.purpose,this.cvv, this.isOtpRequired);

  @override
  _FundTransferConfirmationPageState createState() => _FundTransferConfirmationPageState(selectedDebitAccount,selectedCreditAccount,amount,feeAmount,vatAmount,from,to,purpose,cvv,isOtpRequired);
}

class _FundTransferConfirmationPageState extends State<FundTransferConfirmationPage>
    with
  ...
  void _initiate() async {
    ...
    final bool accountType = (_selectedDebitAccount?.ownershipType == 'Personal' ? true : false);
        ...
        if (_transaction.isRedirectAllow) {
          var result = await Navigator.push(
            ...
            return WebViewGatewayPage(AppLocalizations
                .of(context)
                .fundTransfer, _transaction.redirectUrl);
          }));
  ...
  Future<bool> _showPinDialog(TransactionViewModel transaction) async {
    final result = await Navigator.push(context, MaterialPageRoute(builder: (context) {
      return FundTransferOtpPage(transaction,TransactionAmountDescriptionWidget(transaction));}));
